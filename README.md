...
| Profil Sayfası | <img src="https://user-images.githubusercontent.com/50625747/121392013-a7d4a200-c957-11eb-89a6-f424099c6cea.png" width="300" height="600" /> | hazırlanacak. |

#### Mobil Uygulama Yol Haritası
 - [x] Taslak uygulama tasarımının hazırlanması
 - [x] Ana sayfa (Başlangıç)
 - [x] Arama sayfası
 - [x] Giriş ve kayıt sayfası
 - [x] Profil sayfası
 - [ ] Otel sayfası (Başlangıç)
 - [ ] Profil ve hesap ayarları sayfası
 - [ ] Bildirim sayfası
 - [ ] Favoriler sayfası
 - [ ] Teklifler sayfası
 - [ ] Otel sayfası (Final versiyon)
 - [ ] Ana sayfa (Final Versiyon)
 - [ ] Checkout sayfası
 - [ ] Backend ile birleştirme
